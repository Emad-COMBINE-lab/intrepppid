...
from intrepppid.classifier import ClassifyNet
...
def train_classifier_barlow(
    ...
    net = make_classifier_barlow(barlow_hyperparams, barlow_checkpoint_path, embedding_droprate, do_rate,
                                 steps_per_epoch, num_epochs, fine_tune_epochs)
